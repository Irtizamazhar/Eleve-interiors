...
const products = [
  ...
  { title: 'Acoustic Panels', category: 'Wall Covering', desc: 'Sound-absorbing panels for offices, studios and home cinemas with designer finishes.', img: '/products/acoustic-panels-1.png' },
  { title: 'PU Stone Panels', category: 'Wall Covering', desc: 'Lightweight PU stone panels giving natural stone look on feature walls and exteriors.', img: '/products/pu-stone-panels-1.png' },
  ...
  { title: 'Vertical Blinds', category: 'Window Blinds', desc: 'Functional vertical blinds for large windows, showrooms and offices.', img: '/products/vertical-blinds-1.png' },
  ...
  { title: 'Zebra Blinds', category: 'Window Blinds', desc: 'Day & night zebra blinds with alternating sheer and solid stripes.', img: '/products/zebra-blinds-1.png' },
  ...
  // Floorings
  { title: 'SPC Flooring', category: 'Flooring', desc: 'Waterproof SPC planks ideal for apartments, offices and commercial corridors.', img: '/products/spc-flooring-2.png' },
  ...
  { title: 'Vinyl Flooring', category: 'Flooring', desc: 'Resilient vinyl floors perfect for kitchens, retail and high traffic zones.', img: '/products/vinyl-flooring-3.png' },
  ...
  { title: 'Artificial Grass', category: 'Flooring', desc: 'Soft artificial turf for terraces, balconies, play areas and rooftops.', img: '/products/artificial-grass-1.png' },
  { title: 'Carpet Tiles', category: 'Flooring', desc: 'Durable carpet tiles for modular layouts in offices and institutions.', img: '/products/carpet-tiles-1.png' },
  { title: 'Sports Flooring', category: 'Flooring', desc: 'Multi-purpose sports flooring for indoor courts and activity zones.', img: '/products/sports-flooring-2.png' },
